...
Vagrant.configure("2") do |config|
  ...
  config.vm.hostname = "kandragulamadhu-starter"
  ...
  #   chef.chef_server_url = "https://api.opscode.com/organizations/flabs"
  #   chef.validation_client_name = "flabs-validator"
  #   chef.validation_key_path = ".chef/flabs-validator.pem"
  # end
end
